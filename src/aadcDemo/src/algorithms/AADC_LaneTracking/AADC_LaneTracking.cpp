...
ADTF_FILTER_PLUGIN("AADC LaneTracking", OID_ADTF_LaneTracking, cLaneTracking)
    ...
    m_hEmergencyStopTimerResume(NULL)
{
    ...
    SetPropertyFloat(LT_PROP_MAX_ACCELERATION, 45);
    ...
    SetPropertyFloat(LT_PROP_MIN_ACCELERATION, 35);
